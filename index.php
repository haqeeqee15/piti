        ...
        <div class="grid-cols-2">
          <div class="grid-item-1">
            <h1 class="main-heading">
              Welcome to <span>Piti.</span>
              <br />
              Atur pengeluaran anda.
            </h1>
            <p class="info-text">
            Mulai aware sama pengeluaran anda dari segala sudut.
            </p>

            <div class="btn_wrapper">
             <a href="includes/index.php" button class="btn view_more_btn">
               Mulai Skrg<i class="ri-arrow-right-line"></i>
              </button></a>
<a href ="includes/signup.php">
              <button class="btn documentation_btn">Daftar</button>
</a>
            </div>
          </div>
