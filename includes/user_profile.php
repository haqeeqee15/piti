  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Pengaturan</span>
      </div>
    ...
    <h4 class="text-center"><?php echo $name; ?></h4>
				...
				<div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
						<h3 class="mb-4">Account Pengaturans</h3>
...
<div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
    <h3 class="mb-4">Password Pengaturans</h3>
    <form method="post">
        <?php if (!empty($errors)): ?>
        ...
        <div>
            ...
            <button class="btn btn-light" type="reset">Cancel</button>
					...
					<!-- <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
						<h3 class="mb-4">Security Pengaturans</h3>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
								  	<label>Login</label>
					...
					<div class="tab-pane fade" id="application" role="tabpanel" aria-labelledby="application-tab">
						<h3 class="mb-4">Application Pengaturans</h3>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-check">
					...
					<div class="tab-pane fade" id="notification" role="tabpanel" aria-labelledby="notification-tab">
						<h3 class="mb-4">Notification Pengaturans</h3>
						<div class="form-group">
							<div class="form-check">
