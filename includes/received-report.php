...
function printLaporan() {
  ...
  // Remove the URL from the Laporan
...
// Print the Laporan with the current date in the title
var nw = window.open('', '_blank', 'width=900,height=600');
nw.document.write('<html><head><title>Received Laporan - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Received Laporan</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Received <?php echo ucfirst($rtype); ?> Laporan from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          $userid=$_SESSION['detsuid'];
          $ret=mysqli_query($db,"SELECT name,date_of_Utang,status,description,SUM(amount) as totaldaily FROM `Utang`  where (date_of_Utang BETWEEN '$fdate' and '$tdate') && (UserId='$userid') && (status = 'received') group by date_of_Utang");
          ...
          <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php  echo $row['date_of_Utang'];?></td>
