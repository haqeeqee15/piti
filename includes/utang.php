...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "INSERT INTO Utang (name,UserId, date_of_Utang, amount, description, status) VALUES ('$name','$userid' ,'$date_of_Utang', $amount, '$description', '$status')";
  if (mysqli_query($conn, $sql)) {
    echo '<script type="text/javascript">alert("New Utang record created successfully");</script>';
