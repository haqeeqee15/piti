...
<h2 class="fw-bold mb-2 text-center text-uppercase">Masuk</h2>
<p class="text-black-50 text-center mb-5">Masukkan Email dan Katasandi!</p>
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Lu ngga punya akun? <a href="signup.php"
                class="link-danger">Buat Akunlaaah</a></p>
          </div>
