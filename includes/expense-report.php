...
nw.document.write('<html><head><title>Expense Laporan - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Expense Laporan</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Datewise <?php echo ucfirst($rtype); ?> Laporan from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
