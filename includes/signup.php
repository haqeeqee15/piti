                ...
                <form class="mx-1 mx-md-4" action="" method="post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="text" class="form-control" name="name" id="inputEmail4" required>
                      <label class="form-label" for="form3Example1c">Nama lu</label>
                    </div>
              ...
              Please Enter a valid Username
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example3c">Email lu</label>
                    </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example3c">Nomor telpon lu</label>
                    </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="password" class="form-control" name ="password" id="inputPassword4" required>
                      <label class="form-label" for="form3Example4c">Katasandi lu</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <input type="password" class="form-control" name ="confirm_password" id="inputPassword" required>
                      <label class="form-label" for="form3Example4cd">Katasandi lu lagi</label>
                      <i class="bx bx-hide show-hide"></i>
                    </div>
    ...
    margin-top: -1.5rem;
                  ...
                  <div class="form-check d-flex justify-content-center mb-3">
                    ...
                    <label class="form-check-label" for="form2Example3">
                      Saya setuju dengan semua S&K <a href="#!">Terms of service</a>
                    </label>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit"  name="submit" value="Signup" class="btn btn-primary btn-lg">Buat akun</button>
                  </div>
...
<br> -->
                <p class="text-center text-muted ">Udah punya akun sii <a href="index.php"
                    class="fw-bold text-body link-danger"><u>Masuk sini</u></a></p>
