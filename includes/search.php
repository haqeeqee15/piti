...
$limit = $_POST['limit'];
// Construct SQL query to search for Pengeluaran based on description and user ID
...
// Check if any Pengeluaran were found
if(mysqli_num_rows($result) > 0) {
  ...
  // No Pengeluaran were found
  echo '<p>No Pengeluaran found.</p>';
}
?>
