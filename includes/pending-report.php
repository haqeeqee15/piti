...
nw.document.write('<html><head><title>Pending Laporan - ' + currentDate + '</title></head><body>');
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Pending Laporan</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Pending <?php echo ucfirst($rtype); ?> Laporan from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          $userid=$_SESSION['detsuid'];
          $ret=mysqli_query($db,"SELECT name,date_of_Utang,status,description,SUM(amount) as totaldaily FROM `Utang`  where (date_of_Utang BETWEEN '$fdate' and '$tdate') && (UserId='$userid') && (status = 'pending') group by date_of_Utang");
