...
if (strlen($_SESSION['detsuid']==0)) {
  header('location:logout.php');
    ...
    if (isset($_GET['delid'])) {
        ...
        $query = mysqli_query($db, "DELETE FROM Utang WHERE ID='$rowid'");
        if ($query) {
            echo "<script>alert('Record successfully deleted');</script>";
            echo "<script>window.location.href='manage-Utang.php'</script>";
        } else {
      ...
      window.location.href = window.location.pathname + '?' + urlParams.toString(); // Reload page with new query parameters
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $offset = ($page - 1) * $limit;
                                        $ret=mysqli_query($db,"select * from Utang where UserId='$userid' LIMIT $limit OFFSET $offset");
                                        $cnt = $offset + 1;
                                        ...
                                        ?>
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $row['id']; ?>">
                                              ...
                                              <a class="dropdown-item" href="manage-Utang.php?delid=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i> Delete</a>
                                            </div>
                                          </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-Utang.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-expense-date">Date of Utang:</label>
                                                            <input type="date" class="form-control" id="edit-expense-date" name="date_of_Utang" value="<?php echo $row['date_of_Utang']; ?>">
                                                        </div>
                                                        <div class="form-group">
                            ...
                            <?php
                            $result = mysqli_query($db, "SELECT COUNT(ID) as total FROM Utang ");
