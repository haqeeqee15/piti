...
Daily Expense Tracker System is a web-based application and this application is used to manage the application user‘s daily Pengeluaran in a more efficient and manageable way. By using this application we can reduce the manual calculations for their daily Pengeluaran and keep the track of the Piti. In this application, the user can provide his/her expense to calculate his/her total Pengeluaran per day and these results will be stored for a unique user.
...
🟦 Features :
 ...
 3) user Dashboard
 4) Add-Pengeluaran
 5) Manage Pengeluaran
 6) Add-Utang
 7) Manage Utang
 8) Analisis through graph
 9) Laporan 
 10) Pengaturan
...
🟩 Installation/Setup
 ...
 5) Import the provided SQL file. The file is known as Piti.sql located inside the database folder.
...
✨Screenshots :
   ...
   7) Add-Utang :
      ...
      ![add-Utang](https://user-images.githubusercontent.com/126175004/235641132-644eb6f8-5cf9-49b1-8d3e-612df3829a16.png)
      
   8) Manage-Utang :
      
      ![manage-Utang](https://user-images.githubusercontent.com/126175004/235641243-2ed2b7c0-1204-4208-bd5a-57220003c6f9.png)
      
   9) Analisis :
     
      ![Analisis](https://user-images.githubusercontent.com/126175004/235641350-d98be171-00c2-4572-b723-10ad3a206065.png)
      
   10) Laporan : 
   
       ![Laporan](https://user-images.githubusercontent.com/126175004/235641482-20b0ef0a-4d79-4092-b64d-e1e2ad9b1b7d.png)
